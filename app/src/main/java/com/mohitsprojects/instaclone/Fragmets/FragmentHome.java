...
//        return super.onCreateView(inflater, container, savedInstanceState);
        ...
        progressBar = view.findViewById(R.id.idPostPB);
...
//                            break;
        ...
        chatsBox.setOnClickListener(view1 -> {
            startActivity(new Intent(getActivity(), SearchUserProfile.class));
        });
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    for(int i =0;i<jsonArray.length();i++){
                        ...
                        PostAdaptor postAdaptor = new PostAdaptor(postList, getActivity());
